...
tspeak = None
if os.environ['TS_API_KEY'] and os.environ['TS_MQTT_API_KEY']:
    tspeak = ThingSpeakConnector(os.environ['TS_API_KEY'], os.environ['TS_MQTT_API_KEY'])
    print("Generated Client ID is {}".format(tspeak.client_id))
...
while True:
    ...
    # Send data to ThingSpeak IoT cloud using MQTT
    if tspeak:
        tspeak.send_mqtt(os.environ['TS_CHANNEL_ID'], temperature)
